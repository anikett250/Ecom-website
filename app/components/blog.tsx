...
const Blog = () => {
    return (
        <section className="py-8 md:py-16 bg-white md:bg-gray-50 border border-gray-200 md:border-0">
            <div className="container mx-auto px-4">
                <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 md:mb-12 text-black">Blogs</h2>
                ...
                <div className="text-center mt-6 md:mt-10">
                    <Link href="/" className="inline-block bg-[#DE7A22] text-white font-medium px-8 md:px-[96px] py-3 md:py-[14px] rounded-[10px] transition-colors duration-300">
                        Go to blogs
                    </Link>
                </div>
            </div>
